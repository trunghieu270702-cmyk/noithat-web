    ...
    <div className="overflow-hidden relative pt-[120px] pb-20 modern-section min-h-screen text-gray-900 dark:text-white">
      ...
      <div className="container mx-auto px-6 max-w-[1400px]">
        ...
        <div className="mt-20 text-center">
          <Link href="/tu-van" className="inline-block bg-[#ce9e51] hover:bg-white hover:text-white text-gray-900 dark:text-white font-bold py-4 px-10 rounded-[2px] transition-colors uppercase tracking-wider btn-glow-motion">
