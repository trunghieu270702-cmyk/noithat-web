        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-12">
          {filters.map(filter => (
            <button
              ...
              className={`px-6 py-2 rounded-full text-[13px] font-bold uppercase tracking-wider transition-all duration-300 border ${activeFilter === filter.id
                  ? 'bg-[#D3AE3E] text-white border-[#D3AE3E] shadow-md shadow-[#D3AE3E]/20'
                  : 'modern-section text-gray-600 dark:text-gray-300 border-gray-200 dark:border-white/10 hover:border-[#D3AE3E] hover:text-[#D3AE3E]'
                }`}
            >
              {filter.label}
            </button>
