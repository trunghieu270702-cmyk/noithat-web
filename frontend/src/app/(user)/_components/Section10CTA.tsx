      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 text-center">
        ...
        <ScrollReveal animation="fade-up" delay={500}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="#Form"
              className="inline-flex items-center justify-center px-10 py-5 bg-[#D3AE3E] text-white uppercase tracking-wider text-[14px] font-bold hover:bg-[#b88c45] hover:text-white transition-colors duration-300 rounded-[2px]"
            >
