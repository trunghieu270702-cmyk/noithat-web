      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <ScrollReveal animation="fade-up" delay={100}>
            <h3 className="text-xl font-bold font-['Montserrat',_sans-serif] text-white mb-6 relative pb-4 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-12 after:h-[2px] after:bg-[#D3AE3E]">
              Let's Connect
            </h3>
            <p className="text-[#ccc] text-[15px] font-['Montserrat',_sans-serif] mb-6">
              Luctus nec ullamcorper mattis:
            </p>
            <ul className="space-y-4 text-[#888] font-['Montserrat',_sans-serif] text-[14px]">
            ...
            <div className="space-y-6">
              {RECENT_POSTS.map(post => (
                <div key={post.id} className="flex gap-4 group cursor-pointer">
                  ...
                  <div>
                    <h4 className="text-[14px] font-bold font-['Montserrat',_sans-serif] text-white leading-snug mb-2 group-hover:text-[#D3AE3E] transition-colors line-clamp-2">
                      <Link href={post.link}>{post.title}</Link>
                    </h4>
                    <p className="text-[#888] font-['Montserrat',_sans-serif] text-[12px] uppercase tracking-wider">
                      {post.date}
                    </p>
                  </div>
                </div>
          ...
          <ScrollReveal animation="fade-up" delay={300}>
            ...
            <ul className="space-y-3">
              {SERVICES.map((srv, index) => (
                <li key={index}>
                  <Link href={srv.link} className="flex items-center gap-3 text-[#888] hover:text-[#D3AE3E] font-['Montserrat',_sans-serif] text-[14px] transition-colors group">
          ...
          <ScrollReveal animation="fade-up" delay={400}>
            ...
            <div className="grid grid-cols-3 gap-2">
              {GALLERY.map((imgUrl, idx) => (
                <div key={idx} className="relative aspect-square overflow-hidden bg-[#1a1a1a] cursor-pointer group">
        ...
        <ScrollReveal animation="fade-up" delay={500}>
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-[13px] font-['Montserrat',_sans-serif] text-[#666] hover:text-white transition-colors cursor-pointer text-center md:text-right">
