...
export function ActionMenu({ items }: ActionMenuProps) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="p-1.5 text-gray-400 hover:text-gray-900 hover:bg-gray-100 rounded-[4px] transition-colors cursor-pointer data-[state=open]:bg-gray-100 data-[state=open]:text-gray-900 focus:outline-none">
          ...
          return (
            <React.Fragment key={idx}>
              ...
              <DropdownMenuItem
                ...
                className={`flex items-center gap-2 px-2.5 py-2 text-sm font-medium rounded-[4px] cursor-pointer outline-none transition-colors ${colorClass}`}
              >
